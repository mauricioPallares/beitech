...
INSERT IGNORE INTO `customer` (`customer_id`, `name`, `email`) VALUES
...
DELETE FROM `product`;
INSERT IGNORE INTO `product` (`product_id`, `name`, `description`, `price`) VALUES
...
INSERT IGNORE INTO `customer_has_product` (`customer_id`, `product_id`) VALUES
	(1, 1),
	(1, 2),
	(1, 6),
	(4, 4),
